...
import com.moutamid.talk_togather.Major_Activities.Start_Room_Activity;
...
public class Adapter_Live extends RecyclerView.Adapter<Adapter_Live.HolderAndroid> {
    ...
    public Adapter_Live(Context context, ArrayList<RoomDetails> androidArrayList) {
    ...
    public HolderAndroid onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.row_live_gathering, parent, false);
       ...
       // holder.timer.setText(date);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("id",modelAndroid.getId());
    ...
    class HolderAndroid extends RecyclerView.ViewHolder {
        ...
        HolderAndroid(@NonNull View itemView) {
            ...
            image1 = itemView.findViewById(R.id.img_1_live);
            image2 = itemView.findViewById(R.id.img_2_live);
            image3 = itemView.findViewById(R.id.img_3_live);
            title = itemView.findViewById(R.id.live_title);
            heading = itemView.findViewById(R.id.live_heading);
            timer = itemView.findViewById(R.id.live_connections);
