...
public class UserListAdapter extends RecyclerView.Adapter<UserListAdapter.UserListViewHolder> implements Filterable {
    ...
    public UserListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.user_custom_layout,parent,false);
    ...
    public void onBindViewHolder(@NonNull UserListViewHolder holder, int position) {
        ...
        holder.bioTxt.setText(model.getBio());
        ...
        protected FilterResults performFiltering(CharSequence charSequence) {
            ...
            if (charSequence.toString().isEmpty()) {
                ...
                for (User data : userList) {
                    if (data.getFname().toLowerCase().contains(charSequence.toString().toLowerCase())) {
                        filterList.add(data);
                    }
                }
            }
    ...
    public class UserListViewHolder extends RecyclerView.ViewHolder{
        ...
        public UserListViewHolder(@NonNull View itemView) {
            ...
            bioTxt = itemView.findViewById(R.id.bio);
        }
    }
}
